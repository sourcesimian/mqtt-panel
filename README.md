...
> 
> For users of Node-RED FlowFuse Dashboard 2, see [**node-red-dashboard-2-buttonpanel**](https://github.com/sourcesimian/node-red-dashboard-2-buttonpanel), which brings a similar YAML-configurable button panel experience directly into Node-RED.
